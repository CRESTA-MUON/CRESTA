...
//******************************************************************************
//
#ifndef __CRESTA_PrimaryGeneratorCos2_HH__
#define __CRESTA_PrimaryGeneratorCos2_HH__
...
class PrimaryGeneratorCos2 : public G4VUserPrimaryGeneratorAction
{
public:

    /// Constructor
    PrimaryGeneratorCos2();
...
private:
    ...
    TF1* fThetaPDF; ///< Cos2 distribution for theta
...
//---------------------------------------------------------------------------------
/// Cos2 Flux Processor class : Automatically saves the true muon information
/// for each event into the TTree
class Cos2PrimaryFluxProcessor : public VFluxProcessor {
public:
    /// Processor can only be created with an associated
    /// shukla generator object.
    Cos2PrimaryFluxProcessor(PrimaryGeneratorCos2* gen, bool autosave = true);
    /// Destructor
    ~Cos2PrimaryFluxProcessor() {};
...
protected:
    ...
    PrimaryGeneratorCos2* fGenerator; ///< Pointer to associated generator
