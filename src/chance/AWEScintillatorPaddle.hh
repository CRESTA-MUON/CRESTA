#ifndef __AWEScintillatorPaddle_HH__
#define __AWEScintillatorPaddle_HH__
...
class AWEScintillatorPaddle : public GeoObject {
public:
  inline AWEScintillatorPaddle() {};
  inline AWEScintillatorPaddle(DBTable table) {Construct(table);};
